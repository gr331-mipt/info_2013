...
List *list_add(List *head, List_type item);
//добавить элемент в конец списка
List *list_append(List *head, List_type item);
//вставить элемент в позицию index
List *list_insert(List *head, unsigned index, List_type item);
...
List_type list_get(List *head, unsigned index);
//изменить элемент с номером index
void list_set(List *head, unsigned index, List_type item);
//найти номер первого элемента, равного item (если не найден, возвращается -1)
int list_find(List *head, List_type item);
//длина списка
